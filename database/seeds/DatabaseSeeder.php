...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $product = ['ID' => 1,
            'ID_CATEGORY' => 1,
            'ID_MAKER' => 1,
            'Product_name' => 'Phone iPhone 7 32GB',
        ...
        $product = ['ID' => 2,
            'ID_CATEGORY' => 1,
            'ID_MAKER' => 1,
            'Product_name' => 'Phone iPhone 7 128GB',
        ...
        $product = ['ID' => 3,
            'ID_CATEGORY' => 1,
            'ID_MAKER' => 3,
            'Product_name' => 'Phone Samsung Galaxy S7 Edge',
        ...
        $product = ['ID' => 4,
            'ID_CATEGORY' => 2,
            'ID_MAKER' => 1,
            'Product_name' => 'Tablet iPad Pro Wifi 32GB',
        ...
        $product = ['ID' => 5,
            'ID_CATEGORY' => 2,
            'ID_MAKER' => 1,
            'Product_name' => 'Tablet iPad Pro Wifi 64GB',
        ...
        $product = ['ID' => 6,
            'ID_CATEGORY' => 2,
            'ID_MAKER' => 3,
            'Product_name' => 'Tablet Samsung Galaxy Tab A6 10.1',
        ...
        $product = ['ID' => 7,
            'ID_CATEGORY' => 3,
            'ID_MAKER' => 1,
            'Product_name' => 'Laptop Apple Macbook 12" MLHF2',
        ...
        $product = ['ID' => 8,
            'ID_CATEGORY' => 3,
            'ID_MAKER' => 4,
            'Product_name' => 'Laptop Asus A456UA',
        ...
        $product = ['ID' => 9,
            'ID_CATEGORY' => 3,
            'ID_MAKER' => 4,
            'Product_name' => 'Laptop Asus A456UARA',
        ...
        $product = ['ID' => 10,
            'ID_CATEGORY' => 4,
            'ID_MAKER' => 5,
            'Product_name' => 'Thẻ nhớ 16Gb MicroSD class 10',
        ...
        $product = ['ID' => 11,
            'ID_CATEGORY' => 4,
            'ID_MAKER' => 5,
            'Product_name' => 'Thẻ nhớ 32Gb MicroSD class 10',
        ...
        $product = ['ID' => 12,
            'ID_CATEGORY' => 4,
            'ID_MAKER' => 5,
            'Product_name' => 'Thẻ nhớ 64Gb MicroSD class 10',
        ...
        $product = ['ID' => 13,
            'ID_CATEGORY' => 5,
            'ID_MAKER' => 5,
            'Product_name' => 'Tai nghe Sony MDR - ZX310APRCE',
        ...
        $product = ['ID' => 14,
            'ID_CATEGORY' => 5,
            'ID_MAKER' => 5,
            'Product_name' => 'Tai nghe Kanen JK2',
            'Detail' => '{"connect":"3.5 mm","type":"Tai nghe có dây","featureButton":"Mic, nghe/nhận cuộc gọi, phát/dừng nhạc"}',
            'Media_set' => 'Feature',
            'Price' => 400000,
            'Quantity' => 450,
        ...
        $product = ['ID' => 15,
            'ID_CATEGORY' => 5,
            'ID_MAKER' => 5,
            'Product_name' => 'Tai nghe Cliptec Urban Clubz BMH833',
            'Detail' => '{"connect":"3.5 mm","type":"Tai nghe có dây","featureButton":"Mic, nghe/nhận cuộc gọi, phát/dừng nhạc"}',
            'Media_set' => 'Feature',
            'Price' => 350000,
            'Quantity' => 450,
        ...
        $product = ['ID' => 16,
            'ID_CATEGORY' => 6,
            'ID_MAKER' => 5,
            'Product_name' => 'Cáp USB 20cm eSaver BST-0728',
        ...
        $product = ['ID' => 17,
            'ID_CATEGORY' => 6,
            'ID_MAKER' => 5,
            'Product_name' => 'Cáp USB 50cm X Mobile MU03',
        ...
        $product = ['ID' => 18,
            'ID_CATEGORY' => 6,
            'ID_MAKER' => 5,
            'Product_name' => 'Cáp USB 100cm X Mobile MU03',
        ...
        $product = ['ID' => 19,
            'ID_CATEGORY' => 7,
            'ID_MAKER' => 5,
            'Product_name' => 'Ốp lưng Galaxy J5',
        ...
        $product = ['ID' => 20,
            'ID_CATEGORY' => 7,
            'ID_MAKER' => 5,
            'Product_name' => 'Ốp lưng Galaxy J2 Nhựa dẻo dày bóng Cô gái Nâu',
            'Detail' => '{"material":"Nhựa dẻo"}',
            'Media_set' => 'Feature',
            'Price' => 70000,
            'Quantity' => 450,
        ...
        $product = ['ID' => 21,
            'ID_CATEGORY' => 7,
            'ID_MAKER' => 5,
            'Product_name' => 'Ốp lưng Galaxy J7 Nhựa dẻo dày bóng Cô gái Đỏ',
            'Detail' => '{"material":"Nhựa dẻo"}',
            'Media_set' => 'Feature',
            'Price' => 80000,
            'Quantity' => 350,
        ...
        $product = ['ID' => 25,
            'ID_CATEGORY' => 9,
            'ID_MAKER' => 5,
            'Product_name' => 'Mouse Zadez M168 Đen bạc',
        ...
        $product = ['ID' => 26,
            'ID_CATEGORY' => 9,
            'ID_MAKER' => 5,
            'Product_name' => 'Mouse Zadez M116 Đen',
            'Detail' => '{"type":"Chuột có dây","dpi":1000,"connect":"USB"}',
            'Media_set' => 'Feature',
            'Price' => 100000,
            'Quantity' => 250,
